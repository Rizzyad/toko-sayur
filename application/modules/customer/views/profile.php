            ...
            <div class="card">
              <div class="card-header bg-primary p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link text-white profil active" href="#profile" data-toggle="tab">Profil</a></li>
                  <li class="nav-item"><a class="nav-link text-white akun " href="#akun" data-toggle="tab">Akun</a></li>
                  <li class="nav-item"><a class="nav-link text-white email" href="#email" data-toggle="tab">Email</a></li>
