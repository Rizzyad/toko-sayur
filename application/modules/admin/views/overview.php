    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-muted d-inline-block mb-0">Dasbor</h6>
        </div>
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-light">
              <li class="breadcrumb-item"><a href="#"><i class="fas text-primary fa-home"></i></a></li>
        ...
        <div class="card-header bg-primary">
          <div class="row align-items-center">
            <div class="col">
              ...
              <h5 class="h3 text-white mb-0">Pendapatan</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
  ...
  <div class="row">
    <div class="col-xl-4">
      ...
      <div class="card">
        ...
        <div class="card-header bg-primary">
          <!-- Title -->
          <h5 class="h3 text-white mb-0">Pelanggan baru</h5>
        </div>
        <!-- Card body -->
        <div class="card-body">
          <!-- List group -->
    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        ...
        <div class="card-header bg-primary">
          <!-- Title -->
          <h5 class="h3 text-white mb-0">Order baru</h5>
        </div>
        <!-- Card body -->
    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        ...
        <div class="card-header bg-primary">
          <!-- Title -->
          <h5 class="h3 text-white mb-0">Pembayaran menunggu konfirmasi</h5>
        </div>
        <!-- Card body -->
        <div class="card-body">
          <!-- List group -->
