    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-muted d-inline-block mb-0">Kelola Kupon Belanja</h6>
        ...
        <div class="modal-body p-0">
          <div class="card bg-white border-0 mb-0">
            <div class="card-header bg-primary">
              <h3 class="card-heading text-white text-center mt-2">Tambah Kupon</h3>
            </div>
    ...
    <div class="modal-dialog modal- modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-body p-0">
          <div class="card bg-white border-0 mb-0">
            <div class="card-header bg-primary">
              <h3 class="card-heading text-white text-center mt-2">Edit Kupon</h3>
            </div>
            <div class="card-body px-lg-5 py-lg-5">
