    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-muted d-inline-block mb-0">Cari Produk</h6>
        </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-header bg-primary">
          <div class="row">
            <div class="col-6">
              <h3 class="mb-0 text-white">Cari Produk</h3>
            </div>
            <div class="col-6 text-white">Menampilkan <?php echo $count; ?> hasil pencarian dengan kata kunci "<b><?php echo $query; ?></b>"</div>
          </div>
        </div>
