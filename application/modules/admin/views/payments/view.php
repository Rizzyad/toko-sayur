        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-muted d-inline-block mb-0">Pembayaran Order #<?php echo $payment->order_number; ?></h6>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-light">
                  <li class="breadcrumb-item"><a class="text-primary" href="#"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a class="text-primary" href="<?php echo site_url('admin/payments'); ?>">Pembayaran</a></li>
      ...
      <div class="row">
          ...
          <div class="card-wrapper">
            <div class="card">
              <div class="card-header bg-primary">
                <h3 class="mb-0 text-white">Pembayaran #<?php echo $payment->order_number; ?></h3>
                <?php if ($flash) : ?>
        ...
        <div class="col-md-4">
            <div class="card card-primary">
              <div class="card-header bg-primary">
                  <h3 class="mb-0 text-white">Bukti Pembayaran</h3>
              </div>
              <div class="card-body p-0">
