    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-muted d-inline-block mb-0">Order #<?php echo $data->order_number; ?></h6>
        </div>
...
<div class="container-fluid mt--6">
  ...
  <div class="row">
      ...
      <div class="card-wrapper">
        <div class="card">
          <div class="card-header bg-primary">
            <h3 class="mb-0 text-white">Data Order</h3>
            <?php if ($order_flash) : ?>
        ...
        <div class="card card-primary">
          <div class="card-header bg-primary">
            <h3 class="mb-0 text-white">Barang dalam pesanan</h3>
          </div>
          <div class="card-body p-0">
    ...
    <div class="col-md-4">
      <div class="card card-primary">
        <div class="card-header bg-primary">
          <h3 class="mb-0 text-white">Data Penerima</h3>
        </div>
        <div class="card-body p-0">
      ...
      <div class="card card-primary" id="#payments">
        <div class="card-header bg-primary">
          <h3 class="mb-0 text-white">Pembayaran</h3>
        </div>
