    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-muted d-inline-block mb-0">Kontak #<?php echo $contact->name; ?></h6>
        </div>
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              <li class="breadcrumb-item"><a class="text-primary" href="#"><i class="fas fa-home"></i></a></li>
              <li class="breadcrumb-item"><a class="text-primary" href="<?php echo site_url('admin/contacts'); ?>">Kontak</a></li>
...
<div class="container-fluid mt--6">
  <div class="row">
      ...
      <div class="card-wrapper">
        <div class="card">
          <div class="card-header bg-primary">
            <h3 class="mb-0 text-white">Data Kontak</h3>
            <?php if ($flash) : ?>
    ...
    <div class="col-md-7">
      <div class="card card-primary">
        <div class="card-header bg-primary">
          <h3 class="mb-0 text-white">Balas Pesan</h3>
        </div>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal-modal-dialog-centered modal-" role="document">
      ...
      <div class="card-header bg-primary">
          <h3 class="card-heading text-white text-center mt-2" id="modal-title-default">Hapus Kontak</h3>
        </div>
