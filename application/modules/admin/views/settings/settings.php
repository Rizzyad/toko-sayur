    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-muted d-inline-block mb-0">Pengaturan Situs</h6>
        </div>
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              <li class="breadcrumb-item"><a class="text-primary" href="<?php echo site_url('admin'); ?>"><i class="fas fa-home"></i></a></li>
...
<div class="container-fluid mt--6">
  ...
  <div class="row">
      ...
      <div class="card-wrapper">
        <div class="card">
          <div class="card-header bg-primary">
            <h3 class="mb-0 text-white">Identitas Toko</h3>
            <?php if ($flash) : ?>
        ...
        <div class="card">
          <div class="card-header bg-primary">
            <h3 class="mb-0 text-white">Pengaturan Pembayaran</h3>
            <button type="button" data-toggle="modal" data-target="#addBankModal" class="btn bg-white btn-add float-right btn-sm" style="margin-top: -30px;"><i class="fas text-primary fa-plus-square"></i></button>
          </div>
          <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-header bg-primary">
          <h3 class="mb-0 text-white">Logo</h3>
        </div>
        <div class="card-body">
          <div class="form-group">
      ...
      <div class="modal-content">
        <div class="modal-body p-0">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-primary">
              <h3 class="card-heading text-white text-center mt-2">Tambah Rekening Bank</h3>
            </div>
